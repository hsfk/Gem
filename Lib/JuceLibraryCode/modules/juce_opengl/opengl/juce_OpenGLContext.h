...
public:
    ...
    */
    ...
    void executeOnGLThread (ShaderType&& functor, bool blockUntilFinished);
...
private:
    ...
    {
        AsyncWorkerFunctor (ShaderType functorToUse) : functor (functorToUse) {}
...
#ifndef DOXYGEN
template <typename ShaderType>
void OpenGLContext::executeOnGLThread (ShaderType&& f, bool shouldBlock) { execute (new AsyncWorkerFunctor<ShaderType> (f), shouldBlock); }
#endif
